...
const DifficultyBadge: React.FC<DifficultyBadgeProps> = ({ difficulty = 'Easy' }) => {
    return (
        <div className={cn("text-sm py-1 px-3 rounded-full", colors[difficulty as keyof typeof colors])}>
            {difficulty}
        </div>)
}
